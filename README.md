...
학생과 테스트 참여자는 다운로드한 프로그램을 수업, 실습, 개인 학습, 연구 참여 목적으로 사용할 수 있습니다. 단, 수정 버전이나 파생 버전은 논문 심사 단계가 끝나기 전까지 공개하지 말아 주세요.
...
The source code is temporarily private while the related paper is under review. During this review period, modified versions, derivative versions, renamed copies, or redistributed edited builds are not permitted.

Students and testers may use the downloadable software for class practice, personal learning, and research participation. Please do not publish modified or derivative versions until the paper review stage is complete.
